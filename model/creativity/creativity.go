...
type Creativity struct {
	...
	CreativityStatus int `json:"creativity_status"`
	...
	// MaskPerfer 是否需要替换
	MaskPerfer bool `json:"mask_perfer"`
	// TitleMaskPerfer 是否需要替换
	TitleMaskPerfer bool `json:"title_mask_perfer"`
	// AuditStatus 审核状态
	...
	ItemInvalidReason int `json:"item_invalid_reason"`
	...
	KosMsgType int `json:"kos_msg_type"`
	// QualInfo 资质信息
